...
<button id="openNav" class="w3-button w3-teal w3-xlarge" onclick="w3_open()">&#9776;</button>
  ...
  <a class="active" onclick="k()">Search</a>
...
<div class='content'>
  ...
  <div class='card l'> 
    ...
    <div class='link'><a href='/uploads",$row1[0]."/".$row1[4]."' download><img src='pdf.png'>   ".$row1[4]."</a></div><br>
    <div class='desc'><b>Description-</b>".$row1[3]."</div><br>
    <div class='by'>Contributed by- ".$row1_[1]."(IIT ".$row1_[5].")</div>
    <br><span class='vote'></span>     ".$row1[5]."
    </div></div></td>
<td>
<div class='content '>
  <div class='card c'> 
    <div class='topic'>".$row2[1]."   ->   ".$row2[2]."</div><br>
    <div class='link'><a href='/uploads",$row2[0]."/".$row2[4]."' download><img src='pdf.png'>   ".$row2[4]."</a></div><br>
    <div class='desc'><b>Description-</b>".$row2[3]."</div><br>
    <div class='by'>Contributed by- ".$row2_[1]."(IIT ".$row2_[5].")</div>
    <br><span class='vote'></span>     ".$row2[5]."
  </div></td>
<td>
...
<div class='content '>
  <div class='card r'> 
    ...
    <div class='link'><a href='/uploads",$row3[0]."/".$row3[4]."' download><img src='pdf.png'>   ".$row3[4]."</a></div><br>
    <div class='desc'><b>Description-</b>".$row3[3]."</div><br>
...
<div class='content'>
  <div class='card l'> 
    <div class='topic'>".$row1[1]."   ->   ".$row1[2]."</div><br>
    <div class='link'><a href='".$row1[4]."' download><img src='pdf.png'>   ".$row1[4]."</a></div><br>
    <div class='desc'><b>Description-</b>".$row1[3]."</div><br>
    <div class='by'>Contributed by- ".$row1_[1]."(IIT ".$row1_[5].")</div>
    <br><span class='vote'></span>    ".$row1[5]."
  </div></td></div>
...
<div class='content'>
  <div class='card c' > 
    <div class='topic'>".$row2[1]."   ->   ".$row2[2]."</div><br>
    <div class='link'><a href='".$row2[4]."' download><img src='pdf.png'>   ".$row2[4]."</a></div><br>
    <div class='desc'><b>Description-</b>".$row2[3]."</div><br>
    <div class='by'>Contributed by- ".$row2_[1]."(IIT ".$row2_[5].")</div>
    <br><span class='vote'></span>    ".$row2[5]."
  </div>
